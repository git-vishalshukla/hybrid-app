...
export class CreateProductComponent extends React.Component {
    ...
    componentDidMount() {
        this.serverRequest = $.get("./mock/create.json", function (categories) {
            this.setState({
    ...
    render() {
        ...
        var categoriesOptions = this.state.categories.map(function (category) {
            return (
                <option key={category.name} value={category.name}>{category.id}</option>
            );
        });
